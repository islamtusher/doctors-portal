...
const Appointment = () => {
    return (
        ...
        <div className="card overflow-visible lg:card-side lg:items-center rounded-none bg-[url('/public/assets/images/appointment.png')]">
            <figure className='lg:w-1/2'>
                <img className=' mt-[-150px]  hidden lg:block' src="./assets/images/doctor-small.png" alt="Album" />
            </figure>
            <div className=" lg:w-1/2">
                <div className="card-body gap-6 lg:w-4/5 w-full text-white">
